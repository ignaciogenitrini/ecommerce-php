			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						...
						<form action="<?php	echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="form-signin">
				...
				<div class="col-sm-4">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="<?php	echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="form-signup">
							<input type="text" placeholder="Usuario" name="user"/>
							<input type="email" placeholder="Email Address" name="email"/>
							<input type="password" placeholder="Clave" name="password"/>
							<input type="password" placeholder="Confirmar Clave" name="password2"/>
							<button type="submit" name="submit-register" class="btn btn-default">Registrate</button> 
							<br>
						</form>
